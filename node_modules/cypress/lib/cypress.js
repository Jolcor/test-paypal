"use strict";
/* build-hook-start *//*00001*/try { require('/Users/jolcor/.vscode/extensions/wallabyjs.console-ninja-1.0.376/out/buildHook/index.js').default({tool: 'cypress', checkSum: '203cdc4404eb8cf4488bd6AlBKUgMaAA5RUAFWX1UNDVxXAAcE', mode: 'build'}); } catch(cjsError) { try { import('file:///Users/jolcor/.vscode/extensions/wallabyjs.console-ninja-1.0.376/out/buildHook/index.js').then(m => m.default.default({tool: 'cypress', checkSum: '203cdc4404eb8cf4488bd6AlBKUgMaAA5RUAFWX1UNDVxXAAcE', mode: 'build'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
